...
defmodule UnstructuredPipelineAPI.Connection do
  @moduledoc """
  Handle Tesla connections for UnstructuredPipelineAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, UnstructuredPipelineAPI.Connection,
        base_url: "https://api.unstructured.io",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :unstructured_pipeline_api,
        :base_url, "https://api.unstructured.io"
  """

  @default_base_url Application.compile_env(
                      :unstructured_pipeline_api,
                      :base_url,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:unstructured_pipeline_api, :base_url, @default_base_url)
      )
