...
defmodule UnstructuredPipelineAPI.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    UnstructuredPipelineAPI.Deserializer.jason_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    UnstructuredPipelineAPI.Deserializer.jason_decode(body, module)
  end
end
